...
public class DeleteTestZnanjaTest {
    ...
    void testExecuteOperation() throws Exception {
        ...
        Controller.getInstance().obrisiTestZnanja(testZnanja);
        testovi = Controller.getInstance().nadjiTestoveZnanja(searchParameter);
        containsTestZnanja = !testovi.isEmpty();
        Assertions.assertFalse(containsTestZnanja);
    }
}
